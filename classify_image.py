...
def main(_):
  ...
  image = "/home/cheese/Downloads/image_duck.jpg"
  logging.basicConfig(format='%(asctime)s %(message)s', filename='log/image_classify.log',level=logging.DEBUG)
